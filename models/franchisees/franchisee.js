...
franchiseeSchema.index({franchisee_name: 'text'},{partner_name:'text'},{franchisee_address:'text'},{franchisee_city:'text'},{franchisee_pincode:'text'},{franchisee_franchise_type:'text'})
