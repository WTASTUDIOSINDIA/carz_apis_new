...
// const access_token = '1994150194009398|-7JyOIiFJj8pGPAmvCzKbZv8WB4';
// const app_secret = 'c960c8fc254604e66df3001702456483';
// const app_id = '1994150194009398';
// const id = '<ID>';
...
// var ACCESS_TOKEN_PATH = require('../../token/access_token')
...
console.log(req.query,'+++++++++++++++++++++++')
  entry.forEach(page => {
    page.changes.forEach(change => {
      ...
      console.log(
        // `Page ID ${141028109311252}, Form ID ${2173107573007712}, Lead gen ID ${leadgen_id}`
        `Page ID ${page_id}, Form ID ${form_id}, Lead gen ID ${leadgen_id}`
      );

      // Call graph API to requ est lead info with the lead ID and access token.
        ...
        Stages.findOne({ franchisee_id: stageForm.franchisee_id }, function (err, stage) {
            ...
            if (stage) {
                ...
                if (stageForm.sub_stage === 'payment') {
                    ...
                    if (stage.stage_discussion.payment_status === 'uploaded') {
                ...
                if (stageForm.sub_stage === 'nda') {
                    ...
                    if (stageForm.nda_status === "approved" || "declined") {
                        stage.notification_to = "franchisee"
                    }
                ...
                if (stageForm.sub_stage == 'application_form') {
                    ...
                    if (stage.stage_discussion.application_status === "approved" || "declined") {
                        stage.notification_to = "franchisee"
                    }
                ...
                stage.save(function (err, stage) {
                    ...
                    if (err) {
                        ...
                        console.log(activity_data, 'notif3', stage)
        ...
        console.log(franchiseeForm);
                ...
                Franchisee.findOne({ 'franchisee_email': franchiseeForm.franchisee_email }, function (err, franchisee) {
                    ...
                    if (!franchisee) {
                        ...
                        var franchisee = new Franchisee();
                        let franchisee_details = {};
                        franchisee_details.franchisee_name = franchiseeForm.franchisee_name;
                        franchisee_details.franchisee_pass = createHash('mypassword');
                        franchisee_details.franchisee_email = franchiseeForm.franchisee_email;
                        franchisee_details.franchisee_mobile_number = franchiseeForm.franchisee_mobile_number;
                        franchisee_details.partner_name = franchiseeForm.franchisee_name;
