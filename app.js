...
// app.use(cors('cors'))
app.use(cors({credentials: true, origin: ['http://localhost:4200', 'http://localhost:4200/#/', 'https://carz-web.herokuapp.com', 'https://carz-web.herokuapp.com/#/', 'http://ec2-13-228-158-215.ap-southeast-1.compute.amazonaws.com']}));
app.use(logger('dev'));
app.use(session({
