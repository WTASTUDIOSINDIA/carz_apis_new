...
app.use(function(req, res, next) {
  var allowedOrigins = ['http://localhost:4200', 'https://carz-web.herokuapp.com', 'https://carz-web.herokuapp.com/#/', 'http://ec2-13-228-158-215.ap-southeast-1.compute.amazonaws.com'];
...
// app.use(cors('cors'))
// app.use(cors({credentials: true, origin:  ['http://localhost:4200/#/', 'https://carz-web.herokuapp.com', 'https://carz-web.herokuapp.com/#/', 'http://ec2-13-228-158-215.ap-southeast-1.compute.amazonaws.com']}));
app.use(cors({ origin:  ['http://localhost:4200/#/', 'https://carz-web.herokuapp.com', 'https://carz-web.herokuapp.com/#/', 'http://ec2-13-228-158-215.ap-southeast-1.compute.amazonaws.com'], methods: 'GET,HEAD,PUT,PATCH,POST,DELETE', allowedHeaders: ['Content-Type', 'Authorization', 'Origin', 'x-access-token', 'XSRF-TOKEN'], preflightContinue: false }));
app.use(logger('dev'));
app.use(session({
